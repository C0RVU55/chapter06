...
public class Client {
	...
	public static void main(String[] args) throws IOException {
		// Network Thread 다른 컴퓨터에서 작동될 프로그램
		// 명령 프롬프트에서 실행 : 먼저 서버를 켜야 작동되고 java파일이 아니라 컴파일된 class가 실행됨. "패키지.클래스명" 이렇게 실행해야 함.
		...
		while (true) {
			...
			if("/q".equals(str)) { // str.equals("/q")이면 str이 nullpoint 될 수도 있어서 저렇게 쓰는 게 더 좋은 코드
				break;
			}
